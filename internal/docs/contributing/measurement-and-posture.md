...
7. File a docs PR or issue describing the new dimension; a maintainer will land the internal architecture-doc updates.
...
- [Posture Model](../product/posture-model.md) — five-dimension posture framework
