...
- `internal/docs/engineering/e2e-scenario-testing.md` -- E2E test details
- `docs/internal/engineering/cli-and-docs-regression-testing.md` -- CLI test details
- `internal/docs/engineering/ui-regression-testing.md` -- View-model test details
