...
> **Historical note:** This pass predates the Go-native conversion migration completion and the retirement of the legacy JavaScript runtime on 2026-04-04. Entries about `bin/terrain.js`, TypeScript graph packaging ownership, and JS runtime decisions are preserved as historical analysis, not current product state.
