...
See also:
- `internal/docs/engineering/e2e-scenario-testing.md` for full pipeline tests
- `docs/user-guides/output-modes.md` for user-facing output documentation
- `docs/internal/engineering/verification-system-map.md` for the full test layer diagram
