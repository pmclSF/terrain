...
func DeriveEvals(root string, detection *DetectResult, codeSurfaces []models.CodeSurface, testFiles []models.TestFile) []models.Eval {
	var scenarios []models.Eval
...
func deriveFromEvalTests(root string, testFiles []models.TestFile, surfacesByPath map[string][]models.CodeSurface, prompts, datasets map[string]string) []models.Eval {
	var scenarios []models.Eval
...
func deriveFromAIImports(root string, testFiles []models.TestFile, detection *DetectResult, prompts, datasets map[string]string) []models.Eval {
...
func deduplicateScenarios(scenarios []models.Eval) []models.Eval {
