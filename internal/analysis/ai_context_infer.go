...
var (
	...
	// Markers are tightened to avoid matching codegen templates: the
	// generic `do not` and `instructions?:` patterns caught every
	// "DO NOT EDIT — generated by …" header in Flutter/Dart/Go/Ruby/
	// Ansible codegen output. Replaced with patterns that almost only
