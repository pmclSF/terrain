...
// # Calibration
//
// Per-rule, per-cohort weights live in calibration.go. The composer
// is the only consumer of the calibration table; stages just emit
// atoms with their declared default weight.
package aipipeline
