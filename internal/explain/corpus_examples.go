...
// findings. The JSON ships embedded in the binary so no network or
// filesystem dependency at runtime.
//
// Source: tier-4/corpus-examples.json, generated by
// `terrain-corpus build-examples` from the 326-repo public corpus.
