/**
 * Shared helper for Jest→Mocha fixture tests.
 *
...
export async function getPipeline() {
  ...
  const { default: mochaDef } = await import('../../../src/languages/javascript/frameworks/mocha.js');

  registry.register(jestDef);
  registry.register(mochaDef);
...
export async function runFixture(dir, id, options = {}) {
  ...
  const result = await pipe.convert(input, 'jest', 'mocha');
