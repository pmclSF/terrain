...
> **Historical document.** This describes the V2 converter architecture (JavaScript ES modules).
> The current product direction is V3: signal-first test intelligence.
